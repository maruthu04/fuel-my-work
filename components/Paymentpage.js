    ...
    return (
      <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50">
        ...
        <p className="text-lg text-gray-600 mb-8">
          The user{" "}
          <span className="font-bold text-orange-600">@{username}</span> does
          not exist.
        </p>
        <Link href="/">
  ...
  return (
    <>
      ...
      <div className="cover-image relative">
        <img
          className="cover-image w-full h-[350px] object-cover"
        ...
        <div className="profile absolute -bottom-16 left-1/2 transform -translate-x-1/2">
          <img
            width={140}
            height={140}
            className="rounded-full bg-slate-600 border-4 border-white object-cover aspect-square"
        ...
        <div className="supporters w-1/2 bg-gray-50 border border-gray-400 rounded-xl shadow-sm text-gray-900 p-4">
          ...
          <ul className="mx-4 text-lg max-h-[300px] overflow-y-auto custom-scrollbar">
            ...
            {supporters.map((p, i) => (
              <li
                key={i}
                className="flex gap-2 items-center mb-3 bg-white p-3 rounded-lg border border-gray-200"
              >
        ...
        <div className="makePayment w-1/2 bg-gray-50 border border-gray-400 rounded-xl shadow-sm text-gray-900 p-4">
          ...
          <div className="flex mt-2 gap-2">
            <input
              ...
              className="border border-gray-400 rounded-xl p-2 w-[75%]"
            />
            <button
          ...
          <div className="amount flex gap-4 mt-6">
            <button
              className="border border-blue-600 rounded-xl p-2 bg-blue-100 hover:bg-blue-200 font-bold"
